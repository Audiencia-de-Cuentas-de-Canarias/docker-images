...
CREATE USER REXP_SCVAL IDENTIFIED BY REXP_SCVAL;
ALTER USER "REXP_SCVAL" DEFAULT ROLE ALL;
grant all privileges to REXP_SCVAL;
ALTER USER REXP_SCVAL DEFAULT TABLESPACE TS_EXP_TCUV2;

CREATE USER REXP_TCU_CUENTAS IDENTIFIED BY REXP_TCU_CUENTAS;
ALTER USER "REXP_TCU_CUENTAS" DEFAULT ROLE ALL;
grant all privileges to REXP_TCU_CUENTAS;
ALTER USER REXP_TCU_CUENTAS DEFAULT TABLESPACE TS_EXP_TCUV2;

CREATE USER TEST_DUMMY_SCHEMA IDENTIFIED BY TEST_DUMMY_SCHEMA;
ALTER USER "TEST_DUMMY_SCHEMA" DEFAULT ROLE ALL;
grant all privileges to TEST_DUMMY_SCHEMA;
ALTER USER TEST_DUMMY_SCHEMA DEFAULT TABLESPACE TS_EXP_TCUV2;
